...
class SemanticAnalysis(BaseModel):
    ...
    expected_data_format: Literal["text", "list", "table", "mixed"] | None = None
    force_no_hallucination: bool | None = None
...
def _derive_should_use_internet(raw: dict, message: str) -> bool:
    ...
    raw.get("risk_level") or "low"
    intent = (raw.get("intent_type") or "").lower()
    set(raw.get("sensitivity") or [])
...
async def analyze_message_semantics(message: str, now_iso: str | None = None) -> SemanticAnalysis:
    """

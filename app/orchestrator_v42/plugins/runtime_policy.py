...
def choose_key_and_limits(
    ...
    Seçim öncesi tüm anahtarların hata pencerelerini (prune_errors) günceller.
    """
    # 1. Anahtar Kontrolü
    ...
    # State'i güncelle ve 5 dk penceresini temizle
    for k in available_keys:
        state.prune_errors(k, now_ts)
    ...
    # 4. Timeout Belirleme (Blueprint v1.0 Tier bazlı)
    timeout_map = {
        "genel_hizli_v1": 15,
        "genel_dengeli_v1": 30,
        "sosyal_uzman_v1": 35,
    ...
    # Varsayılan 30
    timeout = timeout_map.get(selected_model_id, 30)

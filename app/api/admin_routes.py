...
class AdminUserUpdate(BaseModel):
    role: str | None = Field(None, description="user / vip / admin")
    censorship_level: int | None = Field(None, ge=0, le=2)
    can_use_internet: bool | None = None
    can_use_image: bool | None = None
    can_use_local_chat: bool | None = None
    is_banned: bool | None = None
    daily_internet_limit: int | None = Field(None, ge=0, le=10000)
    daily_image_limit: int | None = Field(None, ge=0, le=10000)
...
class AdminCreateInvite(BaseModel):
    note: str | None = Field(None, description="Şimdilik sadece log için.")
...
class IdentityUpdate(BaseModel):
    ...
    forbid_provider_mention: bool | None = None
...
class SummarySettingsUpdate(BaseModel):
    ...
    summary_first_threshold: int | None = Field(None, ge=1, le=1000)
    summary_update_step: int | None = Field(None, ge=1, le=1000)
    summary_max_messages: int | None = Field(None, ge=5, le=200)

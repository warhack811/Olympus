...
class SystemConfig(SQLModel, table=True):
    ...
    default_value: str | None = Field(default=None, sa_column=Column(Text))

    # Zaman Damgaları
    created_at: datetime = Field(default_factory=datetime.utcnow)
    updated_at: datetime = Field(default_factory=datetime.utcnow)
    updated_by: str | None = Field(default=None, max_length=64)  # Admin username
...
class ThemeConfig(SQLModel, table=True):
    ...
    # Özel CSS (opsiyonel)
    custom_css: str | None = Field(default=None, sa_column=Column(Text))
...
class PersonaConfig(SQLModel, table=True):
    ...
    description: str | None = Field(default=None, max_length=512)
    icon: str | None = Field(default="💬", max_length=8)  # Emoji veya icon adı
    ...
    preferred_model_purpose: str | None = Field(default=None, max_length=32)
...
class ImageGenConfig(SQLModel, table=True):
    ...
    vae: str | None = Field(default=None, max_length=256)

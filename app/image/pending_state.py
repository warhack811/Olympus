...
def register_pending_job(job_id: str, username: str, conversation_id: str | None, queue_pos: int) -> None:
...
def update_pending_job(job_id: str, progress: int | None = None, queue_pos: int | None = None) -> None:

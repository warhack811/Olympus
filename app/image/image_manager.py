...
from app.core.websockets import send_progress
...
def _on_job_finished(job_id: str | None = None) -> None:
...
async def request_image_generation(
    ...
    try:
        ...
        spec = None
        CHECKPOINTS[FluxVariant.STANDARD]
    ...
    job = ImageJob(
        ...
        image_settings=image_settings,  # Pass settings
    )

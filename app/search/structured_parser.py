...
def parse_exchange_rate_result(snippets: list[SearchSnippet], base: str, quote: str) -> dict | None:
...
def parse_sports_fixture_result(snippets: list[SearchSnippet], team_name: str) -> dict | None:
...
def parse_standings_result(snippets: list[SearchSnippet], league_name: str) -> dict | None:
